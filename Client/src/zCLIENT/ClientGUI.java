...
public class ClientGUI extends javax.swing.JFrame implements Runnable {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Perform IP scanning logic here
    // This code will be executed when the "Quét IP" button is clicked
    
    // For example, you can use the following code to scan IP addresses:
        try {
        ...
        for (int i = 1; i <= 254; i++) {
            ...
            if (isValidIPv4(ipAddress)) {
                System.out.println("Valid IPv4 Address: " + ipAddress);
                // You can proceed with sending this address to the server or performing other actions.
            } else {
