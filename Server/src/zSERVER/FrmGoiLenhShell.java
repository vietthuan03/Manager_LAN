...
public class FrmGoiLenhShell extends javax.swing.JDialog implements Runnable{
    ...
    private void initComponents() {
        ...
        txtMessages.setDisabledTextColor(new java.awt.Color(204, 255, 255));
        jScrollPane1.setViewportView(txtMessages);

        txtInput.setBackground(new java.awt.Color(0, 51, 51));
        txtInput.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtInput.setForeground(new java.awt.Color(255, 255, 255));
        txtInput.setDisabledTextColor(new java.awt.Color(204, 255, 255));
        txtInput.setSelectedTextColor(new java.awt.Color(204, 255, 255));
        txtInput.setSelectionColor(new java.awt.Color(204, 255, 255));
