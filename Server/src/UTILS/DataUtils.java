...
public class DataUtils {
    ...
    public static String nhanDuLieu(Socket sender) {
        try {
//            InputStreamReader dùng để chuyển dữ liệu từ byte sang kí tự 
//            Dùng BufferesdReader dùng để dọc dữ liệu kí tự theo từng dòng
            BufferedReader inputServer =
//                    đọc dữ liệu từ InputStream từ sender object của socket
